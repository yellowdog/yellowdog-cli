...
WIRING = [
    ...
    ("browse_results_directory", "_browse_results_directory_action"),
    ("clear_command_output", "_clear_output_action"),
    ("copy_command_output", "_copy_output_action"),
    ("save_command_output", "_save_output_action"),
    ("show_config", "_show_config_action"),
    ("show_wr_json", "_show_wr_json_action"),
    ("show_wp_json", "_show_wp_json_action"),
    ("deselect_files", "_deselect_files_action"),
    ("browse_config_directory", "_browse_config_directory_action"),
    ...
    ("output_filter_hidden_lines", "_show_all_output"),
]

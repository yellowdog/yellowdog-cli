...
_COMMANDS: list[tuple[str, str]] = [
    ...
    ("yd-compute-restart", "Restart Instances"),
    ("yd-compute-start", "Start stopped Compute Requirements and Instances"),
    ("yd-compute-stop", "Stop Compute Requirements and Instances"),
